...
Those are `05-broken-timing.md`, `06-duplicate-stamps.md` and
`07-misplaced-deck-stamp.md`, on purpose — a folder of fixtures should contain its
broken cases. Exit code 1 is the correct outcome here.
